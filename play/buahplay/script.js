...
const questionBank = [
  {src:'imgb/1a.jpeg', choices:['いちご','トマト','スイカ','グラビオラ'], answer:0,
   hint:'Buah merah kecil dengan biji di luar, manis asam.'},
  {src:'imgb/2.jpeg', choices:['マンゴスチン','うスイカま','トマト','いちご'], answer:0,
   hint:'Disebut ratu buah, kulitnya ungu pekat, daging putih manis.'},
  {src:'imgb/3.jpeg', choices:['ジャックフルーツ','パパイヤ','マンゴスチン','マンゴー'], answer:2,
   hint:'Kulit ungu pekat, daging putih, sering jadi ratu buah.'},
  {src:'imgb/4.jpeg', choices:['オレンジ','ライム','レモン','グレープフルーツ'], answer:2,
   hint:'Buah sitrus kuning, rasa asam segar, kaya vitamin C.'},
  {src:'imgb/5.jpeg', choices:['デーツ','パパイヤ','メロン','パッションフルーツ'], answer:1,
   hint:'Kulit oranye, daging lembut oranye, biasa untuk rujak.'},
  {src:'imgb/6.jpeg', choices:['トマト','うスイカま','マンゴスチン','スターフルーツ'], answer:3,
   hint:'Berbentuk bintang saat diiris, rasa manis asam segar.'},
  {src:'imgb/7.jpeg', choices:['オリーブ','バニラ','サポジラ','バナナ'], answer:1,
   hint:'Sumber aroma es krim, polong cokelat kehitaman.'},
  {src:'imgb/8.jpeg', choices:['スイカ','オリーブ','サラック','ペピーノ'], answer:0,
   hint:'Buah besar hijau, daging merah berair, favorit musim panas.'},
  {src:'imgb/9.jpeg', choices:['たか','オリーブ','チェンペダク','ペピーノ'], answer:2,
   hint:'Mirip nangka, harum khas, populer di Asia Tenggara.'},
  {src:'imgb/10.jpeg', choices:['ランサット','オリーブ','ペピーノ','メロン'], answer:0,
   hint:'Buah kecil berwarna kuning pucat, rasa manis agak asam.'},

  // Tambahan
  {src:'imgb/11.jpeg', choices:['グレープフルーツ','サポジラ','ドラゴンフルーツ','レモン'], answer:2,
   hint:'Kulit merah muda bersisik, daging putih/merah, biji hitam.'},
  {src:'imgb/12.jpeg', choices:['バナナ','メロン','ドラゴンフルーツ','サポジラ'], answer:1,
   hint:'Buah bulat hijau, daging oranye/hijau, harum dan manis.'},
  {src:'imgb/13.jpeg', choices:['ランブータン','サポジラ','グレープフルーツ','バナナ'], answer:0,
   hint:'Kulit merah berbulu, daging putih bening manis.'},
  {src:'imgb/14.jpeg', choices:['スターフルーツ','りんご','ドラゴンフルーツ','ドリアン'], answer:1,
   hint:'Buah merah/hijau, renyah manis, ikon buah dunia.'},
  {src:'imgb/15.jpeg', choices:['サポジラ','スターフルーツ','メロン','にんじん'], answer:3,
   hint:'Sayuran oranye manis, sering dijus atau dimasak sup.'},
  {src:'imgb/16.jpeg', choices:['メロン','にんじん','スターフルーツ','ドリアン'], answer:3,
   hint:'Dikenal sebagai raja buah, berduri tajam, aroma kuat.'},
  {src:'imgb/17.jpeg', choices:['ブラックベリー','ブルーベリー','アボカド','ざくろ'], answer:3,
   hint:'Kulit merah keras, biji banyak berair ruby merah.'},
  {src:'imgb/18.jpeg', choices:['アボカド','ブラックベリー','ざくろ','ブルーベリー'], answer:0,
