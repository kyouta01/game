...
const questionBank = [
  {src:'imgb/1a.jpeg', choices:['ペンギン','カメ','とり','さかな'], answer:0, hint:'Hewan di kutub utara.'},
  {src:'imgb/2.jpeg',  choices:['カニ','うま','たか','いぬ'],       answer:0, hint:'Memiliki 2 capit.'},
  {src:'imgb/3.jpeg',  choices:['イーグル','しか','カメ','ねこ'],    answer:2, hint:'Membawa rumah di punggung.'},
  {src:'imgb/4.jpeg',  choices:['イーグル','うま','いぬ','カメ'],    answer:2, hint:'Suka menggonggong.'},
  {src:'imgb/5.jpeg',  choices:['ぶた','ぎゅう','ペンギン','いぬ'],  answer:1, hint:'Menghasilkan susu.'},
  {src:'imgb/6.jpeg',  choices:['うま','さかな','とり','ぶた'],      answer:3, hint:'Berwarna pink.'},
  {src:'imgb/7.jpeg',  choices:['ライオン','わに','ぞう','とら'],     answer:1, hint:'Julukan playboy.'},
  {src:'imgb/8.jpeg',  choices:['さかな','へび','ライオン','とら'],    answer:0, hint:'Berenang di air.'},
  {src:'imgb/9.jpeg',  choices:['たか','しか','かも','ねこ'],        answer:2, hint:'Unggas bisa berenang.'},
  {src:'imgb/10.jpeg', choices:['うさぎ','へび','ペンギン','わに'],   answer:0, hint:'Telinganya panjang.'},
  // Tambahan 10 soal
  {src:'imgb/11.jpeg', choices:['きつね','ねずみ','ねこ','しか'],     answer:2, hint:'Suka whiskas.'},
  {src:'imgb/12.jpeg', choices:['うし','ぞう','やぎ','ラマ'],         answer:1, hint:'Telinganya besar.'},
  {src:'imgb/13.jpeg', choices:['えび','かえる','とんぼ','とり'],    answer:0, hint:'Suka dibalik batu.'},
  {src:'imgb/14.jpeg', choices:['ねこ','たこ','さかな','うま'],      answer:1, hint:'8 tentacle.'},
  {src:'imgb/15.jpeg', choices:['わに','さめ','いるか','くじら'],    answer:3, hint:'Punya gym di Bikini Bottom.'},
  {src:'imgb/16.jpeg', choices:['とり','あり','はち','へび'],        answer:3, hint:'Temanmu.'},
  {src:'imgb/17.jpeg', choices:['ペンギン','アリゲーター','ヘビ','サメ'], answer:3, hint:'Gawr Gura.'},
  {src:'imgb/18.jpeg', choices:['イカ','いぬ','ライオン','とら'],    answer:0, hint:'Tintanya warna hitam.'},
  {src:'imgb/19.jpeg', choices:['にわとり','かも','かえる','カラス'], answer:2, hint:'Amfibi.'},
  {src:'imgb/20.jpeg', choices:['たこ','ねずみ','もぐら','カメ'],   answer:0, hint:'Sering jadi takoyaki.'},
];
